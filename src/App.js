...
import { EventEdit, EventList, EventShow } from "./component/event";
import { ProfessionalEdit, ProfessionalList, ProfessionalShow } from "./component/Professional";
import { VictimEdit, VictimList, VictimShow } from "./component/victim";
...
const App = () => (
  <Admin
    ...
    appLayout={Layout}
  >
    <Resource name="Event" list={EventList} options={{ label: "Historico de Eventos" }} edit={EventEdit} show={EventShow} />
    <Resource name="Victim" list={VictimList} options={{ label: "Victimas" }} edit={VictimEdit} show={VictimShow} />
    <Resource
      name="Professional"
    ...
    <Resource name="Announcements" options={{ label: "Anuncios" }} list={ListGuesser} edit={EditGuesser} show={ShowGuesser} />
    <Resource name="Blogs" options={{ label: "Blog" }} list={ListGuesser} edit={EditGuesser} show={ShowGuesser} />
    <Resource
