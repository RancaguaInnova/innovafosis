...
export const VictimList = props => (
  <List {...props} title="Listado de victimas">
    <Datagrid rowClick="edit">
      ...
      <ReferenceManyField label="Eventos relacionados" reference="Event" target="victimId" linkType="show">
        <SingleFieldList>
          <ChipField source="date" label="Fecha" />
        </SingleFieldList>
      </ReferenceManyField>
      <TextField source="document" label="Documento" />
      <TextField source="sex" label="Sexo" />
      <ReferenceField label="Profesional Asignado" source="professionalIdAssigned" reference="Professional" linkType="show">
...
export const VictimShow = props => (
  <Show {...props}>
    <SimpleShowLayout>
      ...
      <TextField source="address.number" label="Numero" />
